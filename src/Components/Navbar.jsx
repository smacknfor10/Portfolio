        ...
        <>
            ...
            <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-3 flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm" : ""}`}>
                ...
                <div className='flex items-center gap-4'>
                    ...
                    <a href="#contact" className='hidden lg:flex items-center gap-3 px-10 py-2.5 border text-black border-blue-700 hover:bg-blue-50 rounded-full ml-4'>Contact <img src={assets.arrow_icon} alt="contact" className='w-3' /></a>
